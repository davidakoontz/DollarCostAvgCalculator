...
import XCTest
@testable import DollarCostAvgCalculator
...
class DCAServiceTests: XCTestCase {
    ...
    func testResult_givenWinningAssetAndDCAIsUsed_expectPositiveGains() {
        ...
        let result = sut.calculate(asset: asset,
                                   ...
                                   monthlyDCAAmount: monthlyDollarCostAveragingAmount,
    ...
    private func buildWinningAsset() -> Asset {
        ...
        return Asset(searchResultItem: searchResult,
    ...
    private func buildSearchResult() -> SearchResultItem {
        return SearchResultItem(symbol: "XYZ", name: "XYZ Company", type: "ETF", currency: "USD")
    }
